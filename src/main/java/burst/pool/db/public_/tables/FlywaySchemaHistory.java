 ...
 */
package burst.pool.db.public_.tables;


import burst.pool.db.public_.Indexes;
import burst.pool.db.public_.Keys;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = 1934056589;
