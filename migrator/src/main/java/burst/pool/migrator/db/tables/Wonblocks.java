...
public class WonBlocks extends TableImpl<WonBlocksRecord> {
    ...
    private static final long serialVersionUID = 750457461;
     ...
     */
    public final TableField<WonBlocksRecord, Long> BLOCK_HEIGHT = createField("block_height", org.jooq.impl.SQLDataType.BIGINT.defaultValue(DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>won_blocks.block_id</code>.
     */
    public final TableField<WonBlocksRecord, Long> BLOCK_ID = createField("block_id", org.jooq.impl.SQLDataType.BIGINT.defaultValue(DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>won_blocks.generator_id</code>.
     */
    public final TableField<WonBlocksRecord, Long> GENERATOR_ID = createField("generator_id", org.jooq.impl.SQLDataType.BIGINT.defaultValue(DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<WonBlocksRecord, Long> FULL_REWARD = createField("full_reward", org.jooq.impl.SQLDataType.BIGINT.defaultValue(DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");
