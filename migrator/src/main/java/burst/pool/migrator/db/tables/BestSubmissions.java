...
public class BestSubmissions extends TableImpl<BestSubmissionsRecord> {
    ...
    private static final long serialVersionUID = 1863374951;
     ...
     */
    public final TableField<BestSubmissionsRecord, Long> ACCOUNT_ID = createField("account_id", org.jooq.impl.SQLDataType.BIGINT.defaultValue(DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");
