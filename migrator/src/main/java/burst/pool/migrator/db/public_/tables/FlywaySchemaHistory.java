 ...
 */
package burst.pool.migrator.db.public_.tables;


import burst.pool.migrator.db.public_.Indexes;
import burst.pool.migrator.db.public_.Keys;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = -882837894;
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, Timestamp> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
