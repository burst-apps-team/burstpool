...
import burst.pool.migrator.nogroddb.performance_schema.tables.records.FileSummaryByEventNameRecord;
...
public class FileSummaryByEventName extends TableImpl<FileSummaryByEventNameRecord> {
    ...
    private static final long serialVersionUID = 1210959967;
