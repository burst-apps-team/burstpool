...
import burst.pool.migrator.nogroddb.information_schema.tables.records.EnginesRecord;
...
public class Engines extends TableImpl<EnginesRecord> {
    ...
    private static final long serialVersionUID = 1093518666;
     ...
     */
    public final TableField<EnginesRecord, String> ENGINE = createField("ENGINE", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.SUPPORT</code>.
     */
    public final TableField<EnginesRecord, String> SUPPORT = createField("SUPPORT", org.jooq.impl.SQLDataType.VARCHAR(8).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.COMMENT</code>.
     */
    public final TableField<EnginesRecord, String> COMMENT = createField("COMMENT", org.jooq.impl.SQLDataType.VARCHAR(160).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.TRANSACTIONS</code>.
     */
    public final TableField<EnginesRecord, String> TRANSACTIONS = createField("TRANSACTIONS", org.jooq.impl.SQLDataType.VARCHAR(3).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.XA</code>.
     */
    public final TableField<EnginesRecord, String> XA = createField("XA", org.jooq.impl.SQLDataType.VARCHAR(3).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.ENGINES.SAVEPOINTS</code>.
     */
    public final TableField<EnginesRecord, String> SAVEPOINTS = createField("SAVEPOINTS", org.jooq.impl.SQLDataType.VARCHAR(3).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
