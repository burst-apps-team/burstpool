...
import burst.pool.migrator.nogroddb.information_schema.tables.records.SpatialRefSysRecord;
...
public class SpatialRefSys extends TableImpl<SpatialRefSysRecord> {
    ...
    private static final long serialVersionUID = 1490791182;
     ...
     */
    public final TableField<SpatialRefSysRecord, Short> SRID = createField("SRID", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "");

    /**
     * The column <code>information_schema.SPATIAL_REF_SYS.AUTH_NAME</code>.
     */
    public final TableField<SpatialRefSysRecord, String> AUTH_NAME = createField("AUTH_NAME", org.jooq.impl.SQLDataType.VARCHAR(512).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.SPATIAL_REF_SYS.AUTH_SRID</code>.
     */
    public final TableField<SpatialRefSysRecord, Integer> AUTH_SRID = createField("AUTH_SRID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.SPATIAL_REF_SYS.SRTEXT</code>.
     */
    public final TableField<SpatialRefSysRecord, String> SRTEXT = createField("SRTEXT", org.jooq.impl.SQLDataType.VARCHAR(2048).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
