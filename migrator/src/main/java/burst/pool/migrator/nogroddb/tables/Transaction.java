...
public class Transaction extends TableImpl<TransactionRecord> {
    ...
    private static final long serialVersionUID = -1615056335;

    /**
     * The reference instance of <code>nogrod_vlp.transaction</code>
     */
    ...
    /**
     * The column <code>nogrod_vlp.transaction.id</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.transaction.transaction_id</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.transaction.block_height</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.transaction.created</code>.
     */
    ...
    /**
     * Create a <code>nogrod_vlp.transaction</code> table reference
     */
    public Transaction() {
    ...
    /**
     * Create an aliased <code>nogrod_vlp.transaction</code> table reference
     */
    ...
    public List<ForeignKey<TransactionRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TransactionRecord, ?>>asList(Keys.TRANSACTION_BLOCK_FK);
    }

    public Block block() {
        return new Block(this, Keys.TRANSACTION_BLOCK_FK);
    }
