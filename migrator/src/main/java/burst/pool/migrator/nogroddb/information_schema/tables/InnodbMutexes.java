...
import burst.pool.migrator.nogroddb.information_schema.tables.records.InnodbMutexesRecord;
...
public class InnodbMutexes extends TableImpl<InnodbMutexesRecord> {
    ...
    private static final long serialVersionUID = -1022937095;
     ...
     */
    public final TableField<InnodbMutexesRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR(4000).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_MUTEXES.CREATE_FILE</code>.
     */
    public final TableField<InnodbMutexesRecord, String> CREATE_FILE = createField("CREATE_FILE", org.jooq.impl.SQLDataType.VARCHAR(4000).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_MUTEXES.CREATE_LINE</code>.
     */
    public final TableField<InnodbMutexesRecord, UInteger> CREATE_LINE = createField("CREATE_LINE", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_MUTEXES.OS_WAITS</code>.
     */
    public final TableField<InnodbMutexesRecord, ULong> OS_WAITS = createField("OS_WAITS", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
