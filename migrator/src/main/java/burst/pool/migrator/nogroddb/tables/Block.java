...
public class Block extends TableImpl<BlockRecord> {
    ...
    private static final long serialVersionUID = -1394583216;

    /**
     * The reference instance of <code>nogrod_vlp.block</code>
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.height</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.base_target</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.scoop</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.generation_signature</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.winner_verified</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.reward</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.winner_id</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.best_nonce_submission_id</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.created</code>.
     */
    ...
    /**
     * The column <code>nogrod_vlp.block.generation_time</code>.
     */
    ...
    /**
     * Create a <code>nogrod_vlp.block</code> table reference
     */
    public Block() {
    ...
    /**
     * Create an aliased <code>nogrod_vlp.block</code> table reference
     */
    ...
    public List<ForeignKey<BlockRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<BlockRecord, ?>>asList(Keys.WINNER_ACCOUNT_FK, Keys.NONCE_SUBMISSION_FK);
    }

    public Account account() {
        return new Account(this, Keys.WINNER_ACCOUNT_FK);
    }

    public NonceSubmission nonceSubmission() {
        return new NonceSubmission(this, Keys.NONCE_SUBMISSION_FK);
    }
