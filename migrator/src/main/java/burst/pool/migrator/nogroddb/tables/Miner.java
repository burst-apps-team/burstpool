...
public class Miner extends TableImpl<MinerRecord> {
    ...
    private static final long serialVersionUID = 1367807339;

    /**
     * The reference instance of <code>nogrod_vlp.miner</code>
     */
    ...
    /**
     * Create a <code>nogrod_vlp.miner</code> table reference
     */
    public Miner() {
    ...
    /**
     * Create an aliased <code>nogrod_vlp.miner</code> table reference
     */
     ...
     */
    @Override
    public List<ForeignKey<MinerRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<MinerRecord, ?>>asList(Keys.MINER_ACCOUNT_FK);
    }

    public Account account() {
        return new Account(this, Keys.MINER_ACCOUNT_FK);
    }
