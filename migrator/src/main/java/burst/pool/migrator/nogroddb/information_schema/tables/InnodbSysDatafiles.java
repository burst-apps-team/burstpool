...
import burst.pool.migrator.nogroddb.information_schema.tables.records.InnodbSysDatafilesRecord;
...
public class InnodbSysDatafiles extends TableImpl<InnodbSysDatafilesRecord> {
    ...
    private static final long serialVersionUID = -1136879606;
     ...
     */
    public final TableField<InnodbSysDatafilesRecord, UInteger> SPACE = createField("SPACE", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_DATAFILES.PATH</code>.
     */
    public final TableField<InnodbSysDatafilesRecord, String> PATH = createField("PATH", org.jooq.impl.SQLDataType.VARCHAR(4000).nullable(false).defaultValue(org.jooq.impl.DSL.field("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
